...
class _FiltrosPageState extends State<FiltrosPage> {
  ...
  Future loadData() async {
    final data = await DatabaseHelper.instance.getAll("filtros");
    setState(() => itens = data);
  }

  Future deleteItem(int id) async {
    await DatabaseHelper.instance.delete("filtros", id);
    loadData();
  }
    ...
    showDialog(
      ...
      builder: (_) => AlertDialog(
        ...
        actions: [
          TextButton(
            onPressed: () async {
              await DatabaseHelper.instance.update("filtros", {
                "id": item["id"],
                "nome": nome.text,
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () async {
          await Navigator.push(
              context,
              MaterialPageRoute(builder: (_) => const AddFiltros()));
          loadData();
        },
      ),
      body: Column(
