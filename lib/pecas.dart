...
class _PecasPageState extends State<PecasPage> {
  ...
  Future loadData() async {
    final data = await DatabaseHelper.instance.getAll("pecas");
    setState(() => itens = data);
  }

  Future deleteItem(int id) async {
    await DatabaseHelper.instance.delete("pecas", id);
    loadData();
  }
    ...
    showDialog(
      ...
      builder: (_) => AlertDialog(
        ...
        actions: [
          TextButton(
            onPressed: () async {
              await DatabaseHelper.instance.update("pecas", {
                "id": item["id"],
                "nome": nome.text,
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () async {
          await Navigator.push(
              context,
              MaterialPageRoute(builder: (_) => const AddPecas()));
          loadData();
        },
      ),
      body: Column(
